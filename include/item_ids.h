...
/*
 * Engine item-id enum, split out of item.h so C++ translation units (the
 * native randomizer) can use the authoritative values without pulling in the
 * item.h prototypes that name a parameter `this`. item.h includes this header.
 */
