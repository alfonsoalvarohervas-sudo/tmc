...
static const FlagInfo kBank0Flags[] = {
    { "BEGIN", "" },
    { "LV0_CLEAR", "undocumented" },
    { "LV1_CLEAR", "undocumented" },
    { "LV2_CLEAR", "undocumented" },
    { "LV3_CLEAR", "undocumented" },
    { "LV4_CLEAR", "undocumented" },
    { "LV5_CLEAR", "undocumented" },
    { "LV6_CLEAR", "undocumented" },
    { "LV7_CLEAR", "undocumented" },
    { "LV8_CLEAR", "undocumented" },
    { "MACHI_SET_1", "Defeated Big Green Chuchu" },
    { "MACHI_SET_2", "Defeated Gleerok" },
    { "MACHI_SET_3", "undocumented" },
    { "MACHI_SET_4", "Defeated Big Octorok" },
    { "MACHI_SET_5", "Defeated Gyorg Pair" },
    { "MACHI_SET_6", "undocumented" },
    { "MACHI_SET_7", "undocumented" },
    { "MACHI_SET_8", "undocumented" },
    { "MACHI_MACHIHOKORI", "Sucked dust from carpet" },
    { "START", "Met Zelda" },
    { "EZERO_1ST", "Met Ezlo" },
    { "TABIDACHI", "Talked to Daltus and Smith" },
    { "LV1TARU", "undocumented" },
    ...
    { "TATSUMAKI", "undocumented" },
    { "KUMOTATSUMAKI", "Vortex spawned" },
    { "KAITENGIRI", "undocumented" },
    { "DAIKAITENGIRI", "undocumented" },
    { "GATOTSU", "undocumented" },
    { "KABUTOWARI", "undocumented" },
...
const char* Port_DebugQuery_FlagName(int bank, int index) {
    if (bank < 0 || bank >= 13) return "UNKNOWN";
    if (index < 0 || (size_t)index >= kBanks[bank].count) return "UNKNOWN";
    return kBanks[bank].flags[index].name;
}

const char* Port_DebugQuery_FlagDesc(int bank, int index) {
    if (bank < 0 || bank >= 13) return "";
    if (index < 0 || (size_t)index >= kBanks[bank].count) return "";
